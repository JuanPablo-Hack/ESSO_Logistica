...
<footer id="footer" class="footer">
    <div class="container">
        <div class="row gy-4">
            <div class="col-lg-5 col-md-12 footer-info">
                ...
                <p>
                    We are a company founded by specialized personnel
                    in transportation, distribution and customs trade in
                    national territory, the main objective being the
                    cost reduction.
                </p>
            </div>
            ...
            <div class="col-lg-3 col-md-12 footer-contact text-center text-md-start">
                ...
                <p>
                    Tabachines 2088 <br />
                    Neighborhood 5 Valley of the Garzas
    ...
    <div class="container mt-4">
        <div class="copyright">
            &copy; Copyright <strong><span>ESSO</span></strong>. All rights reserved
        </div>
        <div class="credits">
            Designed by <a href="https://jupitersoft.tech/">JupiterSoft</a>
        </div>
    </div>
</footer>
